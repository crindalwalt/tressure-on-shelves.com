                            ...
                            <div class="dash-info-widget mt-4 mt-lg-0 py-4 px-3 rounded">
                                ...
                                <div class="media mt-4">
                                    ...
                                    <div class="media-body ps-3">
                                        ...
                                        <p class="text-muted mb-0">To Online <a href="#" class="text-primary">View
                    ...
                    <ul class="list-unstyled activity-wid mb-0">
                        ...
                        <li class="activity-list activity-border">
                            <div class="activity-icon avatar-sm">
                                ...
                                <img src="admin-assets/images/users/avatar-7.jpg" class="avatar-sm rounded-circle"
                                    alt="">
                                ...
                                <div class="media-body">
                                    <div class="text-end d-none d-md-block">
                                        <p class="text-muted font-size-13 mt-2 pt-1 mb-0"><i
                                                class="mdi mdi-timer-outline font-size-15 text-primary"></i> 3 days</p>
                                    </div>
                                </div>
                        ...
                        <li class="activity-list activity-border">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <div class="text-end d-none d-md-block">
                                        <p class="text-muted font-size-13 mt-2 pt-1 mb-0"><i
                                                class="mdi mdi-timer-outline font-size-15 text-primary"></i> 1 days</p>
                                    </div>
                                </div>
                        ...
                        <li class="activity-list activity-border">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <div class="text-end d-none d-md-block">
                                        <p class="text-muted font-size-13 mt-2 pt-1 mb-0"><i
                                                class="mdi mdi-timer-outline font-size-15 text-primary"></i> Today</p>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <div class="row align-items-center mb-5">
                                    <div class="col-md-4">
                                        <img src="admin-assets/images/product/img-3.png" class="img-fluid me-3"
                                            alt="">
                                    </div>
                            ...
                            <div class="carousel-item">
                                <div class="row align-items-center mb-5">
                                    <div class="col-md-4">
                                        <img src="admin-assets/images/product/img-5.png" class="img-fluid me-3"
                                            alt="">
                                    </div>
                                    <div class="col-md-7 offset-md-1">
                            ...
                            <div class="carousel-item">
                                <div class="row align-items-center mb-5">
                                    <div class="col-md-4">
                                        <img src="admin-assets/images/product/img-1.png" class="img-fluid me-3"
                                            alt="">
                                    </div>
                                    <div class="col-md-7 offset-md-1">
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>#2356</td>
                                    <td><img src="admin-assets/images/product/img-7.png" width="42"
                                ...
                                <tr>
                                    <td>#2564</td>
                                    <td><img src="admin-assets/images/product/img-8.png" width="42"
                                ...
                                <tr>
                                    <td>#2125</td>
                                    <td><img src="admin-assets/images/product/img-10.png" width="42"
                                ...
                                <tr>
                                    <td>#8587</td>
                                    <td><img src="admin-assets/images/product/img-11.png" width="42"
                                ...
                                <tr>
                                    <td>#2354</td>
                                    <td><img src="admin-assets/images/product/img-12.png" width="42"
